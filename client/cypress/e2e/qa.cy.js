...
describe('example to-do app', () => {
    ...
    it('add new question', () => {
        ...
        cy.get('#answersScroller :last-child #rangeAnswer')
            .should('be.visible');

        cy.get('#answersScroller :last-child #rangeAnswer')
            .as('range').invoke('val', 9).trigger('change');

        cy.get('#answersScroller :last-child #postRangeBtn').should('be.visible');

        cy.get('#answersScroller :last-child #postRangeBtn').click();
    });
