...
contract QAReward {
    ...
    event AwardSent(address indexed receiver, address indexed sender, uint256 amount);
    ...
    function proposeAward(string memory question, uint timeoutDate) public payable{
        ...
        QuestionData storage _question = questionData[question];
    ...
    function award(string memory question)public payable{
        ...
        for(i=0; i<3; i++){
            ...
            emit AwardSent(_question.provider, answerer, _award);
        }
    }
}